...
#Source:         https://github.com/farsightsec/golang-framestream/archive/%{commit}/%{name}-%{version}.tar.gz
Source:         https://github.com/farsightsec/golang-framestream/archive/broken-name.tar.gz
